...
def-env activate-virtualenv [] {
    ...
    let virtual-env = 'C:\Users\fortt\Desktop\zuridjangotask\somaenv'
    let bin = 'Scripts'
    let path-sep = ';'
...
alias deactivate = source 'C:\Users\fortt\Desktop\zuridjangotask\somaenv\Scripts\deactivate.nu'
